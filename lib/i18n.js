...
(function (root) {
  ...
  const DICT = {
    ...
    "health.warn": {
      de: "⚠️ Auf {portal} wurde zuletzt {n}-mal in Folge kein Kontaktformular gefunden. Vermutlich hat das Portal seine Seiten umgebaut – prüfe im Chrome Web Store, ob es ein Update gibt, oder melde es kurz per E-Mail (Impressum). Deine gespeicherten Daten sind davon nicht betroffen.",
      en: "⚠️ On {portal}, no contact form was found {n} times in a row. The portal probably changed its pages – check the Chrome Web Store for an update, or drop a short e-mail (see imprint). Your saved data is not affected.",
    },
    ...
    "stats.tooFewOne": { de: "erst 1 Bewerbung (Quote ab {min})", en: "only 1 application (rate from {min})" },
    "stats.leadTone": {
    ...
    "tracker.cleanup": { de: "Aufräumen", en: "Clean up" },
    "tracker.cleanupNone": { de: "Nichts aufzuräumen – keine Einträge älter als {days} Tage ohne Antwort/Besichtigung.", en: "Nothing to clean up – no entries older than {days} days without a reply/viewing." },
    "tracker.cleanupConfirm": {
      de: "{n} Einträge löschen, die älter als {days} Tage sind und weder Antwort noch Besichtigung haben? Aktive Kontakte bleiben. Das lässt sich nicht rückgängig machen.",
      en: "Delete {n} entries older than {days} days without a reply or viewing? Active contacts are kept. This cannot be undone.",
    },
    "tracker.cleanupDone": { de: "{n} alte Einträge gelöscht ✓", en: "{n} old entries deleted ✓" },
    ...
    "profile.progressReady": { de: "Startklar ✓ – jedes weitere Feld macht die Anschreiben persönlicher", en: "Ready to go ✓ – every extra field makes your letters more personal" },
    "profile.progressFull": { de: "Startklar ✓ – Profil vollständig", en: "Ready to go ✓ – profile complete" },
    ...
    // Zweite Person im Haushalt (Paar/WG/Familie). Die Beziehungs-Optionen sind
    // im Deutschen die fertige Formulierung – der Brief beugt sie nach Kasus.
    "p2.summary": { de: "Zweite Person, die mit einzieht (optional)", en: "Second person moving in (optional)" },
    "p2.hint": {
      de: "Für Paare, WGs und Familien: Die Vermietung will wissen, wer mit einzieht und ob zwei Einkommen die Miete tragen. Ausgefüllt wird beides im Anschreiben genannt und beide unterschreiben.",
      en: "For couples, flatshares and families: landlords want to know who else is moving in and whether two incomes cover the rent. If filled in, both appear in the letter and both sign it.",
    },
    "p2.rel": { de: "Beziehung zu dir", en: "Relationship to you" },
    "p2.relNone": { de: "keine zweite Person", en: "no second person" },
    "p2.partnerin": { de: "meine Partnerin", en: "my partner (female)" },
    "p2.partner": { de: "mein Partner", en: "my partner (male)" },
    "p2.ehefrau": { de: "meine Frau", en: "my wife" },
    "p2.ehemann": { de: "mein Mann", en: "my husband" },
    "p2.mitbewohnerin": { de: "meine Mitbewohnerin", en: "my flatmate (female)" },
    "p2.mitbewohner": { de: "mein Mitbewohner", en: "my flatmate (male)" },
    "p2.tochter": { de: "meine Tochter", en: "my daughter" },
    "p2.sohn": { de: "mein Sohn", en: "my son" },
    "p2.name": { de: "Voller Name", en: "Full name" },
    "p2.namePh": { de: "Anna Musterfrau", en: "Anna Musterfrau" },
    "p2.job": { de: "Beruf", en: "Job title" },
    "p2.employment": { de: "Beschäftigung", en: "Employment" },
    "p2.income": { de: "Einkommen (netto/Monat)", en: "Income (net/month)" },
    ...
    // LEG-04: Wahlfelder für chancenmindernde Angaben (Standard: nennen).
    "profile.tellIncome": { de: "Einkommen im Anschreiben nennen", en: "Mention income in the letter" },
    "profile.tellEmployment": { de: "Beschäftigungsstatus im Anschreiben nennen", en: "Mention employment status in the letter" },
    "profile.tellNote": {
      de: "Beides ist freiwillig — rechtlich musst du diese Angaben vor Vertragsschluss meist nicht machen. Mit Angabe wirken Bewerbungen oft stärker, ohne bleibt es deine Entscheidung.",
      en: "Both are optional — legally you usually don’t have to disclose them before signing a lease. Stating them often makes applications stronger; leaving them out stays your choice.",
    },
    "profile.tellIncomeOff": { de: "Einkommen wird in Anschreiben nicht mehr genannt", en: "Income will no longer be mentioned in letters" },
    "profile.tellIncomeOn": { de: "Einkommen wird in Anschreiben genannt", en: "Income will be mentioned in letters" },
    "profile.tellEmploymentOff": { de: "Beschäftigungsstatus wird in Anschreiben nicht mehr genannt", en: "Employment status will no longer be mentioned in letters" },
    "profile.tellEmploymentOn": { de: "Beschäftigungsstatus wird in Anschreiben genannt", en: "Employment status will be mentioned in letters" },
    ...
    "profile.importAll": { de: "Sicherung einlesen", en: "Restore backup" },
    "import.invalid": {
      de: "Keine gültige Sicherung – erwartet wird die JSON-Datei aus „Alle Daten sichern (JSON)“.",
      en: "Not a valid backup – expected the JSON file from “Back up all data (JSON)”.",
    },
    "import.confirm": {
      de: "Sicherung einlesen? {n} Datenbereiche werden übernommen und überschreiben den aktuellen Stand gleichnamiger Bereiche. Das lässt sich nicht rückgängig machen.",
      en: "Restore this backup? {n} data areas will be imported and overwrite the current state of areas with the same name. This cannot be undone.",
    },
    ...
    "ai.permissionRequired": {
      de: "Ohne die Berechtigung für api.anthropic.com kann die KI nicht arbeiten – bitte die Chrome-Nachfrage mit „Zulassen“ bestätigen und erneut speichern.",
      en: "Without permission for api.anthropic.com the AI cannot work – please confirm Chrome's prompt with “Allow” and save again.",
    },
    ...
    "ov.nextLoading": { de: "Nächste Anzeige wird geladen …", en: "Loading the next listing …" },
    "ov.searchFilled": { de: "✓ Filter in die Suchmaske eingetragen", en: "✓ Filters entered into the search form" },
    "ov.searchGo": { de: "Suche jetzt starten", en: "Start the search now" },
    "ov.searchGoFailed": {
      de: "Der Suchknopf des Portals wurde nicht gefunden – bitte klicke ihn selbst.",
      en: "The portal's search button was not found – please click it yourself.",
    },
    "ov.searchConfirmFoot": {
      de: "Nichts wird ohne deinen Klick abgeschickt. Fenster schließen = nichts passiert.",
      en: "Nothing is submitted without your click. Close this window and nothing happens.",
    },
    "ov.searchHintEnd": {
