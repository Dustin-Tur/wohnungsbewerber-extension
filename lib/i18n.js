...
(function (root) {
  ...
  const DICT = {
    ...
    "profile.resetConfirm": { de: "Profil wirklich zurücksetzen?", en: "Really reset your profile?" },
    ...
    "ai.keyHint": { de: "Wird nur lokal in diesem Browser gespeichert.", en: "Stored only locally in this browser." },
